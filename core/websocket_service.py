...
class WebsocketService:
    _websockets_by_user: Dict[str, WebSocket]
    """Maps user_id to a websocket"""
    _websockets_by_game: Dict[str, Dict[str, WebSocket]]
    ...
    def get_websockets_by_game(self, game_id: str) -> Dict[str, WebSocket] | None:
